						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a class="{{ Request::is('pharmacy-admin/order') ? 'active' : '' }}" href="{{ url('pharmacy-admin/order') }}">Order</a></li>
								</ul>
							</li>
							<li class="{{ Request::is('pharmacy-admin/sales') ? 'active' : '' }}"><a href="sales"><i class="fe fe-activity"></i> <span>Sales</span></a></li>
							<li class="submenu">
								<a href="#"><i class="fe fe-user"></i> <span> Supplier</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a class="{{ Request::is('pharmacy-admin/supplier') ? 'active' : '' }}" href="{{ url('pharmacy-admin/supplier') }}">Supplier</a></li>
									<li><a class="{{ Request::is('pharmacy-admin/add-supplier') ? 'active' : '' }}" href="{{ url('pharmacy-admin/add-supplier') }}">Add Supplier</a></li>
								</ul>
							</li>
							<li class="{{ Request::is('pharmacy-admin/transactions-list') ? 'active' : '' }}"><a href="transactions-list"><i class="fe fe-table"></i> <span>Transaction</span></a></li>
							<li class="submenu">
