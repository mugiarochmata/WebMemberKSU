	<!-- jQuery -->
	<script src="{{ URL::asset('assets_admin/js/jquery-3.2.1.min.js')}}"></script>
		
		<!-- Bootstrap Core JS -->
        <script src="{{ URL::asset('assets_admin/js/popper.min.js')}}"></script>
        <script src="{{ URL::asset('assets_admin/js/bootstrap.min.js')}}"></script>
		...
		<!-- Full Calendar JS -->
        <script src="{{ URL::asset('assets_admin/js/jquery-ui.min.js')}}"></script>
        <script src="{{ URL::asset('assets_admin/plugins/fullcalendar/fullcalendar.min.js')}}"></script>
        <script src="{{ URL::asset('assets_admin/plugins/fullcalendar/jquery.fullcalendar.js')}}"></script>
		<!-- Datatables JS -->
		...
		<script  src="{{ URL::asset('assets_admin/js/script.js')}}"></script>
			<script  src="{{ URL::asset('assets_admin/js/custom.min.js')}}"></script>