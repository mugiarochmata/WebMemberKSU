            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            {!! Form::select('productLoanId', $master_product_loans , '',['class' => 'form-control','id'=>'productLoanId', 'required']); !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            {!! Form::select('productLoanKindId', $master_product_loan_kinds , '',['class' => 'form-control','id'=>'productLoanKindId', 'required']); !!}   
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                        {!! Form::text('limitAmount', '', ['id'=>'limitAmount','class' => 'form-control', 'maxlength' => 100, 'required']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-2">
                            {!! Form::text('tenor', '', ['id'=>'tenor','class' => 'form-control', 'maxlength' => 100, 'required']) !!}
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                {!! Form::date('discontoDueDate', '', ['class' => 'form-control', 'maxlength' => 100]) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            {!! Form::text('electronicItemName', '', ['class' => 'form-control', 'maxlength' => 100]) !!}
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label for="formrow-inputCity" class="form-label">Jenis Item Elektronik</label>
                            {!! Form::text('elecronicItemType', '', ['class' => 'form-control', 'maxlength' => 100]) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            {!! Form::text('electronicItemPrice', '', ['class' => 'form-control', 'maxlength' => 100]) !!}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            {!! Form::text('educationKidName', '', ['class' => 'form-control', 'maxlength' => 100]) !!}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            {!! Form::text('downPaymentAmount', '', ['class' => 'form-control', 'maxlength' => 100]) !!}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            {!! Form::select('disbursementBankId', $databank,'', ['class' => 'form-control', 'maxlength' => 100]) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                        {!! Form::text('disbursementBankAccountNumber', '', ['class' => 'form-control', 'maxlength' => 100]) !!}
                        </div>
                    </div>
                </div>
            </div>
